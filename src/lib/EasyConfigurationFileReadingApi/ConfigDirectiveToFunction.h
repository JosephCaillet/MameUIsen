...
namespace ecfra
{
	...
	public:
		...
		ConfigDirectiveToFunction(const std::string& directive, S setter) : valueType(ValueType::STRING),
																			directive(directive), setterS(setter)
		{ }

		ConfigDirectiveToFunction(const std::string& directive, I setter) : valueType(ValueType::INT),
																			directive(directive), setterI(setter)
		{ }

		ConfigDirectiveToFunction(const std::string& directive, F setter) : valueType(ValueType::FLOAT),
																			directive(directive), setterF(setter)
		{ }

		ConfigDirectiveToFunction(const std::string& directive, B setter) : valueType(ValueType::BOOL),
																			directive(directive), setterB(setter)
		{ }
